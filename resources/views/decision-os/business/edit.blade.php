...
@section('title', 'Decision OS | تعديل أصل')
@section('title-sub', 'Decision OS')
@section('pagetitle', 'تعديل أصل')
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="text-muted mb-0">تعديل بيانات الأصل</p>
                    </div>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('decision-os.business.update', $business) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror"
                                    ...
                                    @foreach($typeLabels as $value => $label)
                                        <option value="{{ $value }}" {{ old('type', $business->type) === $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          id="description" name="description" rows="3">{{ old('description', $business->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control" id="active_clients"
                                           name="active_clients" min="0"
                                           value="{{ old('active_clients', $business->active_clients) }}">
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="mrr"
                                               name="mrr" min="0" step="0.01"
                                               value="{{ old('mrr', $business->mrr) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control" id="contracts_signed"
                                           name="contracts_signed" min="0"
                                           value="{{ old('contracts_signed', $business->contracts_signed) }}">
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control" id="systems_deployed"
                                           name="systems_deployed" min="0"
                                           value="{{ old('systems_deployed', $business->systems_deployed) }}">
                                </div>
                            </div>
                                    ...
                                    @foreach($statusLabels as $value => $label)
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                   ...
                                                   {{ old('status', $business->status) === $value ? 'checked' : '' }}>
